    SUBROUTINE REAPAR(CBINFLAG,AEFFA,BETAMI,BETAMX,CALPHA,CFLEPS,CFLPAR,     &
                      ...
                      flgwav,xyzc0,w0) ! Arguments for Gaussian beam incident
...
! Arguments:
   ...
   integer,intent(out)::flgwav
   real(WP),intent(out),dimension(3)::xyzc0 ! Gaussian beam center; in unit of d (dipole spacing)
   real(WP),intent(out)::w0                 ! Gaussian beam waist; in unit of d (dipole spacing)
...
1000     CLOSE(28)
         ...
         CALL WRIMSG('REAPAR',CMSGNM)
      ENDIF
!==== Read Gaussian beam input arguments ===============================
      read(iopar,*) cline
      read(iopar,*) flgwav
      read(iopar,*) xyzc0
      read(iopar,*) w0
