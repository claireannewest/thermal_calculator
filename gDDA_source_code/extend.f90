...
!   IZ for physical sites runs from IPNF(5) to IPNF(5)+IZMAX-IZMIN+1
      ...
      ! write a temparory file for the displacement of diples
      open(unit=22,file='temp-shift.txt',action='write',position='append')
          write(22,*) 1-ixmin+ipnf(1),1-iymin+ipnf(3),1-izmin+ipnf(5)
      close(22)
