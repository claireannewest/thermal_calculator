      SUBROUTINE GETFML(AK_TF,AK3,AKS_TF,BETADF,PHIDF,THETADF,DX,X0,CALPHA,   &
                        ...
                        NTIMERS,NLAR,flgwav,xyzc0,w0,CFLAVG)
...
! Arguments:
      ...
      COMPLEX(WP) ::                    &
         ...
         CXZW(MXNAT,24)
   integer,intent(in) :: flgwav            ! Option for wavefront: 0--planewave; 1 -- Gaussion beam 
...
!***
            CALL EVALE(CXE0_TF,AK_TF,DX,X0,IXYZ0,IOCC,flgwav,xyzc0,w0,MXNAT,MXN3,NAT,NAT0,NX,NY,NZ, &
                       CXE_TF,CFLAVG)
!*** diagnostic
...
!***
         ...
         CALL EVALE(CXE01_TF,AK_TF,DX,X0,IXYZ0,IOCC,flgwav,xyzc0,w0,MXNAT,MXN3,NAT0,NAT0,NX,NY,NZ, &
                    CXE_TF,CFLAVG)
!*** diagnostic
...
!***
         ...
         CALL EVALE(CXE02_TF,AK_TF,DX,X0,IXYZ0,IOCC,flgwav,xyzc0,w0,MXNAT,MXN3,NAT0,NAT0,NX,NY,NZ, &
                    CXE_TF,CFLAVG)
