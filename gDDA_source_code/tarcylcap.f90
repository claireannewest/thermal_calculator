...
! 17.12.06 (BTD): corrected incorrect statement in CDESCR -- make clear
!                 that ASPR refers to cylinder only
! end history
...
! ASPR=aspect ratio (length/diameter)
      ...
      WRITE(CDESCR,FMT='(A,I7,A,I4,A,I4,A,F7.4)')' Cyl.w.caps, NAT=',NAT, &
            ' NFAC=',NFAC,' NLAY=',NLAY,' cyl.asp.ratio=',ASPR
